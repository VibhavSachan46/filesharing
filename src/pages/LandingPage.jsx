...
const LandingPage = () => {
  ...
  return (
    <div className='bg-richblue-400 min-h-screen flex flex-col'>
      {/* Navbar */}
      ...
      <div className='flex flex-col md:flex-row items-center md:items-start flex-1'>
        <div className='flex flex-col mt-8 md:mt-32 px-8 md:px-48 w-full md:w-3/5'>
          ...
          <div className='flex gap-6 md:gap-14 mt-8 md:mt-16'>
            <button
              onClick={handleLogin}
              className="bg-caribbeangreen-400 hover:bg-caribbeangreen-500 text-white font-bold py-2 px-4 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105"
            >
              Login
            </button>
            <button
